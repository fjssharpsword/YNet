...
"""
Dataset: Tuberculosis Chest X-ray Image Data Sets
...
PATH_TO_TRAIN_FILE = '/data/fjsdata/JSRT-CXR/trainset.csv'
PATH_TO_TEST_FILE = '/data/fjsdata/JSRT-CXR/testset.csv'
